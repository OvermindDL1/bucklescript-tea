type t = {
  .
  [@bs.get] [@bs.set] "href": string,
  [@bs.get] [@bs.set] "protocol": string,
  [@bs.get] [@bs.set] "host": string,
  [@bs.get] [@bs.set] "hostname": string,
  [@bs.get] [@bs.set] "port": string,
  [@bs.get] [@bs.set] "pathname": string,
  [@bs.get] [@bs.set] "search": string,
  [@bs.get] [@bs.set] "hash": string,
  [@bs.get] [@bs.set] "username": string,
  [@bs.get] [@bs.set] "password": string,
  [@bs.get] "origin": string,
};
