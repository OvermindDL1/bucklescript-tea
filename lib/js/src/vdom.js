                      ...
                      /* :: */[
                        ...
                        /* :: */[
                          ...
                          /* :: */[
                            tagName,
                            /* :: */[
                              $$String.concat("", Belt_List.mapU(param[4], (function (p) {
                                          var param = p;
                                            ...
                                            switch (param.tag | 0) {
                                              ...
                                              case 4 : 
                                                  return $$String.concat("", /* :: */[
                                                              " style=\"",
                                                              /* :: */[
                                                                $$String.concat(";", Belt_List.mapU(param[0], (function (param) {
                                                                            return $$String.concat("", /* :: */[
                                                                                        param[0],
                                                                                        /* :: */[
                                                                                          ":",
                              ...
                              /* :: */[
                                ">",
                                /* :: */[
                                  $$String.concat("", Belt_List.mapU(param[5], renderToHtmlString)),
                                  /* :: */[
                                    "</",
                                    /* :: */[
                                      tagName,
  ...
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      ...
      case 3 : 
          ...
          return /* () */0;
      case 4 : 
          return Belt_List.reduceU(param[0], /* () */0, (function (_, param) {
    ...
    switch (_newProp.tag | 0) {
      ...
      case 4 : 
          if (typeof oldProp === "number") {
            ...
            return Belt_List.reduce2U(oldProp[0], _newProp[0], /* () */0, (function (_, param, param$1) {
                          var nv = param$1[1];
                          var nk = param$1[0];
                          var ok = param[0];
                          if (ok === nk) {
...
function mapEmptyProps(props) {
  return Belt_List.mapU(props, (function () {
                return /* NoProp */0;
              }));
}
...
function patchVNodesOnElems_ReplaceNode(callbacks, elem, elems, idx, param) {
  if (param.tag === 2) {
    ...
    var match = patchVNodesOnElems_Properties(callbacks, newChild, Belt_List.mapU(newProperties, (function () {
                return /* NoProp */0;
              })), newProperties);
    if (match !== 0) {
