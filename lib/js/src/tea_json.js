...
var string = /* Decoder */[function (value) {
    var match = Web_json.reify_type(value);
    if (match[0] !== 0) {
...
function list(param) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match[0] !== 3) {
              ...
              try {
                return /* Ok */Block.__(0, [List.map(parse, $$Array.to_list(match[1]))]);
              }
              catch (exn){
                if (exn[0] === ParseFail) {
                  return /* Error */Block.__(1, ["Invalid list parsing: " + exn[1]]);
                }
                else {
                  throw exn;
                }
...
function array(param) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match[0] !== 3) {
              ...
              try {
                return /* Ok */Block.__(0, [$$Array.map(parse, match[1])]);
              }
              catch (exn){
                if (exn[0] === ParseFail) {
                  return /* Error */Block.__(1, ["Invalid array parsing: " + exn[1]]);
                }
                else {
                  throw exn;
                }
  ...
  return /* Decoder */[function (value) {
            ...
            if (match[0] !== 3) {
              ...
              if (idx < 0 || idx > a.length) {
                return /* Error */Block.__(1, ["Array index out of range: " + idx]);
              }
              else {
...
function map$1(mapper, param) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              return /* Error */Block.__(1, ["map failed"]);
            }
            else {
...
function map2(mapper, param, param$1) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              return /* Error */Block.__(1, ["map2 failed"]);
            }
            else if (match$1.tag) {
              return /* Error */Block.__(1, ["map2 failed"]);
            }
...
function map3(mapper, param, param$1, param$2) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              return /* Error */Block.__(1, ["map3 failed"]);
            }
            else if (match$1.tag) {
              return /* Error */Block.__(1, ["map3 failed"]);
            }
...
function map4(mapper, param, param$1, param$2, param$3) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              return /* Error */Block.__(1, ["map4 failed"]);
            }
            else if (match$1.tag) {
              return /* Error */Block.__(1, ["map4 failed"]);
            }
...
function map5(mapper, param, param$1, param$2, param$3, param$4) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              return /* Error */Block.__(1, ["map5 failed"]);
            }
            else if (match$1.tag) {
              return /* Error */Block.__(1, ["map5 failed"]);
            }
...
function map6(mapper, param, param$1, param$2, param$3, param$4, param$5) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              return /* Error */Block.__(1, ["map6 failed"]);
            }
            else if (match$1.tag) {
              return /* Error */Block.__(1, ["map6 failed"]);
            }
...
function map7(mapper, param, param$1, param$2, param$3, param$4, param$5, param$6) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              return /* Error */Block.__(1, ["map7 failed"]);
            }
            else if (match$1.tag) {
              return /* Error */Block.__(1, ["map7 failed"]);
            }
...
function map8(mapper, param, param$1, param$2, param$3, param$4, param$5, param$6, param$7) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              return /* Error */Block.__(1, ["map8 failed"]);
            }
            else if (match$1.tag) {
              return /* Error */Block.__(1, ["map8 failed"]);
            }
