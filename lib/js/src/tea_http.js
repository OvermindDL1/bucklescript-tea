...
function track(toMessage, param) {
  ...
  var onprogress = /* Some */[(function (callbacks, ev) {
        var match = Tea_json.Decoder[/* decodeValue */30](Tea_json.Decoder[/* field */11](Tea_json.Decoder[/* bool */5], "lengthComputable"), ev);
        ...
        if (lengthComputable) {
          var decoder = Tea_json.Decoder[/* map2 */17]((function (bytes, bytesExpected) {
                ...
                }), Tea_json.Decoder[/* field */11](Tea_json.Decoder[/* int */3], "loaded"), Tea_json.Decoder[/* field */11](Tea_json.Decoder[/* int */3], "total"));
