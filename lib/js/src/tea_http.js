...
var Web_xmlhttprequest      = require("./web_xmlhttprequest");
...
function track(toMessage, param) {
  ...
  var onprogress = /* Some */[function (callbacks, ev) {
      var match = Curry._2(Tea_json.Decoder[/* decodeValue */30], Curry._2(Tea_json.Decoder[/* field */11], "lengthComputable", Tea_json.Decoder[/* bool */5]), ev);
      var lengthComputable;
      lengthComputable = match.tag ? /* false */0 : match[0];
      if (lengthComputable) {
        var decoder = Curry._3(Tea_json.Decoder[/* map2 */17], function (bytes, bytesExpected) {
              return /* record */[
                      /* bytes */bytes,
                      /* bytesExpected */bytesExpected
                    ];
            }, Curry._2(Tea_json.Decoder[/* field */11], "loaded", Tea_json.Decoder[/* int */3]), Curry._2(Tea_json.Decoder[/* field */11], "total", Tea_json.Decoder[/* int */3]));
        var match$1 = Curry._2(Tea_json.Decoder[/* decodeValue */30], decoder, ev);
        if (match$1.tag) {
          return /* () */0;
        }
        else {
