...
var position = Curry._3(Tea_json.Decoder[/* map2 */17], (function (x, y) {
        return /* record */[
                /* x */x,
                /* y */y
              ];
      }), Curry._2(Tea_json.Decoder[/* field */11], "pageX", Tea_json.Decoder[/* int */3]), Curry._2(Tea_json.Decoder[/* field */11], "pageY", Tea_json.Decoder[/* int */3]));

function registerGlobal(name, key, tagger) {
  var enableCall = function (callbacks_base) {
    var callbacks = [callbacks_base];
    var fn = function (ev) {
      var match = Curry._2(Tea_json.Decoder[/* decodeEvent */31], position, ev);
      if (match.tag) {
        return /* None */0;
      } else {
