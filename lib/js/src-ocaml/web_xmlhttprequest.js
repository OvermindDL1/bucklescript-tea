...
function open_(method$prime, url, asyncOpt, userOpt, passwordOpt, x) {
...
function get_response(x) {
  ...
  switch (s) {
    case /* StringResponseType */0 :
        return /* StringResponse */Block.__(0, [resp]);
    case /* ArrayBufferResponseType */1 :
        return /* ArrayBufferResponse */Block.__(1, [resp]);
    case /* BlobResponseType */2 :
        return /* BlobResponse */Block.__(2, [resp]);
    case /* DocumentResponseType */3 :
        return /* DocumentResponse */Block.__(3, [resp]);
    case /* JsonResponseType */4 :
        return /* JsonResponse */Block.__(4, [resp]);
    case /* TextResponseType */5 :
        return /* TextResponse */Block.__(5, [resp]);
